...
1. cd human_shadow/human_shadow/
```
python generate_train_data.py --demo_names data_jiaying_1 data_jiaying_2 data_marion --smoothed --camera_res 128 --name task1_smooth_128
```

### Train
1. cd robomimic/robomimic/scripts/
```
python train.py --config /juno/u/lepertm/shadow/robomimic/robomimic/exps/real/task1_jiaying12_marion_smooth.json --name task1_smooth_s0 --seed 0
```
